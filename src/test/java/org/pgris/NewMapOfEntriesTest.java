...
public class NewMapOfEntriesTest {
    ...
    @Test
    void testMap4() {
        Map<String, Integer> result = New.mapOfEntries(New.entry("e0", 0), New.entry("e1", 1), New.entry("e2", 2), New.entry("e3", 3));
    ...
    @Test
    void testMap5() {
        Map<String, Integer> result = New.mapOfEntries(New.entry("e0", 0), New.entry("e1", 1), New.entry("e2", 2), New.entry("e3", 3), New.entry("e4", 4));
    ...
    @Test
    void testMap6() {
        Map<String, Integer> result = New.mapOfEntries(New.entry("e0", 0), New.entry("e1", 1), New.entry("e2", 2), New.entry("e3", 3), New.entry("e4", 4), New.entry("e5", 5));
    ...
    @Test
    void testMap7() {
        Map<String, Integer> result = New.mapOfEntries(New.entry("e0", 0), New.entry("e1", 1), New.entry("e2", 2), New.entry("e3", 3), New.entry("e4", 4), New.entry("e5", 5), New.entry("e6", 6));
    ...
    @Test
    void testMap8() {
        Map<String, Integer> result = New.mapOfEntries(New.entry("e0", 0), New.entry("e1", 1), New.entry("e2", 2), New.entry("e3", 3), New.entry("e4", 4), New.entry("e5", 5), New.entry("e6", 6), New.entry("e7", 7));
    ...
    @Test
    void testMap9() {
        Map<String, Integer> result = New.mapOfEntries(New.entry("e0", 0), New.entry("e1", 1), New.entry("e2", 2), New.entry("e3", 3), New.entry("e4", 4), New.entry("e5", 5), New.entry("e6", 6), New.entry("e7", 7), New.entry("e8", 8));
    ...
    @Test
    void testMap10() {
        Map<String, Integer> result = New.mapOfEntries(New.entry("e0", 0), New.entry("e1", 1), New.entry("e2", 2), New.entry("e3", 3), New.entry("e4", 4), New.entry("e5", 5), New.entry("e6", 6), New.entry("e7", 7), New.entry("e8", 8), New.entry("e9", 9));
